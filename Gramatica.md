...
funcion -> "FUNCTION" "IDENTIFICADOR" ["(" parametros_formales ")"]
           ":" tipo ";" ["VAR" lista_variables]
           [declaracion_subprogramas] "BEGIN" [lista_sentencias]
           "END" ";"

procedimiento -> "PROCEDURE" "IDENTIFICADOR" ["(" parametros_formales ")"] ";" 
                 ["VAR" lista_variables] [declaracion_subprogramas]
